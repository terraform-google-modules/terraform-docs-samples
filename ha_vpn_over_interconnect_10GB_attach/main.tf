...
provider "google" {
   ...
   region = "us-east4"  # Region must support the creation of attachments on Dataplane v2
#  zone   = "us-east4-c"
}

provider "google-beta" {
   project = "your-project" # Region must support the creation of attachments on Dataplane v2
   region = "us-east4"
}
