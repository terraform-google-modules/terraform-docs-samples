...
# This DAG will run minutely and handle pub/sub messages
# by triggering target DAG
with DAG(
    "trigger_dag",
    ...
    # Here we acknowledge messages automatically. You can use
    # PubSubHook.acknowledge to acknowledge in downstream tasks
    ...
    # Here we use Dynamic Task Mapping to trigger DAGs
    # according to messages content
