...
# [START cloud_sql_sqlserver_instance_gcbdr_mr_pitr]

data "google_project" "project" {}

resource "google_sql_database_instance" "default" {
  name             = "sqlserver-instance-backup-mr-pitr"
  region           = "us-central1"
  ...
  point_in_time_restore_context {
    ...
    target_instance = "${data.google_project.project.project_id}:sqlserver-instance-backup-mr-pitr"
    region          = "us-central1" # Replace with the region of the source instance if point in time restore is using a multi-region datasource.
  }
}
# [END cloud_sql_sqlserver_instance_gcbdr_mr_pitr]
